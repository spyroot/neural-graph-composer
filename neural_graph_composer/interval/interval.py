...
This adaptation of interval tree code.


The major change here it change many method to handle Float Point Intervals.
Specifically we want handle in robust way if two float near to each other.
...
class FloatInterval(namedtuple('IntervalBase', ['begin', 'end', 'data'])):
    __slots__ = ()  # Saves memory, avoiding the need to create __dict__ for each interval

    def __new__(cls, begin, end, data=None):
        return super(FloatInterval, cls).__new__(cls, begin, end, data)
    ...
    def overlaps(self, begin, end=None):
        ...
        """
        if end is not None:
            return math.isclose(begin, self.end) and end > self.begin
        try:
    ...
    def contains_point(self, p):
        ...
        :rtype: bool
        """
        return math.isclose(self.begin, p) and math.isclose(p, self.end)
    ...
    def distance_to(self, other):
        ...
        :rtype: Number
        """
        print("distance TYPE", type(other))
    ...
    def lt(self, other):
        ...
        :raises ValueError: if either self or other is a null FloatInterval
        :param other: FloatInterval or point
        :return: True or False
        :rtype: bool
        """
    ...
    def isclose(self, other):
        return math.isclose(self.end, getattr(other, 'end', other))

    def le(self, other):
        """Less than or overlaps. Returns True if no part of this FloatInterval
    ...
    def copy(self):
        ...
        :rtype: Interval
        """
        return FloatInterval(self.begin, self.end, self.data)
    ...
    def __reduce__(self):
        ...
        :rtype: tuple
        """
        return FloatInterval, self._get_fields()
